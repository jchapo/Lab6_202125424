!function (t, e) {
    ...
    199: function (t, e, r) {
        ...
        t.exports = function () {
            ...
            function d(t, e) {
                var r = t.element.classList, i = h.scrolling(e);
            ...
            function y(t) {
                var r = t.element, i = Math.floor(r.scrollTop), n = r.getBoundingClientRect();
                t.containerWidth = Math.round(n.width), t.containerHeight = Math.round(n.height), t.contentWidth = r.scrollWidth, t.contentHeight = r.scrollHeight, r.contains(t.scrollbarXRail) || (o(r, c.rail("x")).forEach((function (t) {
                    ...
                    return l(t)
                })), r.appendChild(t.scrollbarYRail)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = X(t, Y(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = Y((t.negativeScrollAdjustment + r.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1, !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight ? (t.scrollbarYActive = !0, t.railYHeight = t.containerHeight - t.railYMarginHeight, t.railYRatio = t.containerHeight / t.railYHeight, t.scrollbarYHeight = X(t, Y(t.railYHeight * t.containerHeight / t.contentHeight)), t.scrollbarYTop = Y(i * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1, t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight), function (t, r) {
            ...
            function W(t, e) {
                var r = e[0], i = e[1], n = e[2], l = e[3], o = e[4], s = e[5], a = e[6], c = e[7], u = e[8],
                    p = t.element, b = null, g = null, v = null;

                function m(e) {
                    e.touches && e.touches[0] && (e[n] = e.touches[0].pageY), p[a] = b + v * (e[n] - g), d(t, c), y(t), e.stopPropagation(), e.type.startsWith("touch") && e.changedTouches.length > 1 && e.preventDefault()
                }
            ...
            var L = {
                "click-rail": function (t) {
                    ...
                    t.event.bind(t.ownerDocument, "keydown", (function (r) {
                        if (!(r.isDefaultPrevented && r.isDefaultPrevented() || r.defaultPrevented) && (n(e, ":hover") || n(t.scrollbarX, ":focus") || n(t.scrollbarY, ":focus"))) {
                            ...
                            t.settings.suppressScrollX && 0 !== o || t.settings.suppressScrollY && 0 !== s || (e.scrollTop -= s, e.scrollLeft += o, y(t), function (r, i) {
                    ...
                    function i(i) {
                        ...
                        if (!function (e, i, n) {
                            ...
                            var s = !1;
                            e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (o ? r.scrollTop -= o * e.settings.wheelSpeed : r.scrollTop += l * e.settings.wheelSpeed, s = !0) : e.scrollbarXActive && !e.scrollbarYActive && (l ? r.scrollLeft += l * e.settings.wheelSpeed : r.scrollLeft -= o * e.settings.wheelSpeed, s = !0) : (r.scrollTop -= o * e.settings.wheelSpeed, r.scrollLeft += l * e.settings.wheelSpeed), y(e), (s = s || function (t, i) {
                    ...
                    if (w.supportsTouch || w.supportsIePointer) {
                        var r = e.element, i = {}, n = 0, l = {}, o = null;
                    ...
                    function d(o) {
                        if (h(o)) {
                            var u = a(o), d = {pageX: u.pageX, pageY: u.pageY}, f = d.pageX - i.pageX,
                                p = d.pageY - i.pageY;
                            if (function (e, i, n) {
                                if (!r.contains(e)) return !1;
                                for (var l = e; l && l !== r;) {
                            ...
                            s(f, p), i = d;
                            var b = (new Date).getTime(), g = b - n;
                            g > 0 && (l.x = f / g, l.y = p / g, n = b), function (t, i) {
                                var n = Math.floor(r.scrollTop), l = r.scrollLeft, o = Math.abs(t), s = Math.abs(i);
                                if (s > o) {
                                    if (i < 0 && n === e.contentHeight - e.containerHeight || i > 0 && 0 === n) return 0 === window.scrollY && i > 0 && w.isChrome
                ...
                }(this.scrollbarY) : null, this.railBorderYWidth = Y(v.borderTopWidth) + Y(v.borderBottomWidth), e(this.scrollbarYRail, {display: "block"}), this.railYMarginHeight = Y(v.marginTop) + Y(v.marginBottom), e(this.scrollbarYRail, {display: ""}), this.railYHeight = null, this.railYRatio = null, this.reach = {
